...
class DataAugmentation:
    ...
    def randomColor(image, label):
        ...
        """
        random_factor = np.random.randint(10, 20) / 10.  # 随机因子
        color_image = ImageEnhance.Color(image).enhance(random_factor)  # 调整图像的饱和度
        #random_factor = np.random.randint(10, 12) / 10.  # 随机因子
        brightness_image = ImageEnhance.Brightness(color_image).enhance(1)  # 调整图像的亮度
...
if __name__ == '__main__':
    threadOPS("C:\\Users\\User\\Desktop\\test",
              "C:\\Users\\User\\Desktop\\test",
              "C:\\Users\\User\\Desktop\\label",
              "C:\\Users\\User\\Desktop\\label"
              )